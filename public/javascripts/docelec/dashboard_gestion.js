$(function(){
  ...
  dataDisplay($("#selectYear").dxSelectBox('instance').option('value'));

  function dataDisplay(year) {
...
poleState.map(function(d){
  ...
  getStackedBar("dxStackedBar"+d.cle,window["storeMontant"+d.cle],"state",series,`Suivi ${d.cle} (montants)`)
  })   
...
.map(function(d){
  ...
  getGroupedBar("dxGroupedBar"+d.cle,window["data"+d.cle],"bdd",series,`Détails par ressource ${d.cle}`) 
})
