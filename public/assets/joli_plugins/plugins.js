    ...
    var formElements = function(){                
        ...
        var feTimepicker = function(){
            ...
            if($(".timepicker24").length > 0)
                $(".timepicker24").timepicker({minuteStep: 5,showSeconds: false,showMeridian: false,defaultTime: false});
       ...
       //Validation Engine, modifié de $("form[id^='validate'] à $("div[class^='validate']
        var feValidation = function(){
            if($("div[class^='validate']").length > 0){
                
                // Validation prefix for custom form elements
                var prefix = "valPref_";
                
                //Add prefix to Bootstrap select plugin
                $("div[class^='validate'] .select").each(function(){
                   $(this).next("div.bootstrap-select").attr("id", prefix + $(this).attr("id")).removeClass("validate[required]");
                });
                
                // Validation Engine init
                $("div[class^='validate']").validationEngine('attach', {promptPosition : "bottomLeft", scroll: false,
