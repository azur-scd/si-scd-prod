module.exports = (sequelize, DataTypes) => {
    const BddGestion = sequelize.define('BddGestion', {
        ...
        montant_ttc_avant_recup: DataTypes.FLOAT,
        montant_tva_avant_recup: DataTypes.FLOAT,
        montant_tva_apres_recup: DataTypes.FLOAT,
    ...
    BddGestion.associate = (models) => {
	 ...
	 BddGestion.belongsTo(models.BddDiscipline,
      {through: "bdds",
      foreignKey: 'bdd_id'});
    };
